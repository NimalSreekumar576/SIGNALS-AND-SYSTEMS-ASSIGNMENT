...
plt.legend(loc='best', title='Passband and Stopband', labels=['Epsilon = 0.309', 'Epsilon = 0.43', 'Epsilon = 0.57', 'Epsilon = 0.61', 'Passband', 'Stopband'])
plt.grid(True)
