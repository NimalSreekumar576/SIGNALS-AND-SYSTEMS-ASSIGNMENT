...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11044 - NIMAL SREEKUMAR$^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/nimal-sing.wav
\end{lstlisting}
\item 
\label{Python code}
...
There are a lot of yellow lines between 440Hz to 1KHz. These represent the synthesizer key tones. Also, the key strokes are audible along with background noise.
...
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/3.2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/3.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/4.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/5.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/5.4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/6_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/6.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/6.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/7.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	...
	&- \brak{0.72}y(n - 3) + \brak{0.12}y(n - 4) \nonumber \\
	&= \brak{1.02\times 10^{-2}}x(n) + \brak{4.08 \times 10^{-2}}x(n - 1) \nonumber \\
	&+ \brak{6.125 \times 10^{-2}}x(n - 2) + \brak{4.08 \times 10^{-2}}x(n - 3) \nonumber \\
	&+ \brak{1.02 \times 10^{-2}}x(n - 4)
\end{align}
...
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/7.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/NimalSreekumar576/SIGNALS-AND-SYSTEMS-ASSIGNMENT/blob/main/Audio_filter/codes/7_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
